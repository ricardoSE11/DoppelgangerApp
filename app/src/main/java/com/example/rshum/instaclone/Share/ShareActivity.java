...
import com.example.rshum.instaclone.Utils.SectionsPagerAdapter;
...
public class ShareActivity extends AppCompatActivity {
    ...
    //sets up ViewPager to manage tabs
    private void setupViewPager(){
        ...
        TabLayout tabLaout = (TabLayout)findViewById(R.id.tabsBottom);
        tabLaout.setupWithViewPager(mViewPager);

        tabLaout.getTabAt(0).setText(getString(R.string.gallery));
        tabLaout.getTabAt(1).setText(getString(R.string.photo));

    }

    //Verify all the permissions passed to the array
    public void verifyPermissions(String[] permissions){
        Log.d(TAG, "verifyPermissions: veryfing permissions");
